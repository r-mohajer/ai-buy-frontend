        ...
        <Colxx xxs="12">
          <Card className="mb-4">
            <CardBody>
              ...
              <InputGroup className="mb-3">
                <InputGroupAddon addonType="prepend">تومن</InputGroupAddon>
          ...
          <Card className="mb-4">
            <CardBody>
              ...
              <InputGroup className="mb-3">
                <InputGroupAddon addonType="prepend">
                  <InputGroupText>تومن</InputGroupText>
          ...
          <Card className="mb-4">
            <CardBody>
              ...
              <InputGroup className="mb-3">
                <InputGroupAddon addonType="prepend">آپلود</InputGroupAddon>
                <CustomInput
                  type="file"
              ...
              <InputGroup className="mb-3">
                <CustomInput
                  ...
                  name="customFile"
                />
                <InputGroupAddon addonType="append">آپلود</InputGroupAddon>
              </InputGroup>
